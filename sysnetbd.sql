...
--
-- Servidor: localhost
-- Tiempo de generación: 13-11-2014 a las 01:57:32
...
CREATE TABLE IF NOT EXISTS `localidades` (
  ...
  `localidad_provincia_id` int(11) NOT NULL,
  `localidad_nombre` varchar(250) NOT NULL,
...
INSERT INTO `localidades` (`localidad_id`, `localidad_provincia_id`, `localidad_nombre`) VALUES
(1, 1, '25 de Mayo'),
(2, 1, '3 de febrero'),
(3, 1, 'A. Alsina'),
...
CREATE TABLE IF NOT EXISTS `matricula` (
  ...
  `matricula_responsable_id` int(11) NOT NULL,
  `matricula_seccion_id` int(11) NOT NULL,
  `matricula_localidad_id` int(11) NOT NULL,
  `matricula_nombre` varchar(100) NOT NULL,
  `matricula_apellido` varchar(100) NOT NULL,
  `matricula_dni` bigint(8) NOT NULL,
  `matricula_cuil` bigint(11) NOT NULL,
  `matricula_calle` varchar(100) NOT NULL,
  `matricula_nro` int(25) NOT NULL,
  `matricula_depto` varchar(25) NOT NULL,
  `matricula_cp` varchar(20) NOT NULL,
  `matricula_tel` bigint(25) NOT NULL,
  `matricula_cel` bigint(25) NOT NULL,
...
--
-- Estructura de tabla para la tabla `matricula_responsables`
--

CREATE TABLE IF NOT EXISTS `matricula_responsables` (
  `responsable_id` int(11) NOT NULL AUTO_INCREMENT,
  `responsable_localidad_id` int(11) NOT NULL,
  `responsable_nombre` varchar(100) NOT NULL,
  `responsable_apellido` varchar(100) NOT NULL,
  `responsable_dni` bigint(8) NOT NULL,
  `responsable_cuil` bigint(11) NOT NULL,
  `responsable_calle` varchar(100) NOT NULL,
  `responsable_nro` int(25) NOT NULL,
  `responsable_depto` varchar(25) NOT NULL,
  `responsable_cp` varchar(20) NOT NULL,
  `responsable_tel` bigint(25) NOT NULL,
  `responsable_cel` bigint(25) NOT NULL,
  `responsable_email` varchar(100) NOT NULL,
  PRIMARY KEY (`responsable_id`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;

--
-- Volcar la base de datos para la tabla `matricula_responsables`
--
...
--
-- Estructura de tabla para la tabla `matricula_secciones`
--

CREATE TABLE IF NOT EXISTS `matricula_secciones` (
  `seccion_id` int(11) NOT NULL AUTO_INCREMENT,
  `seccion_nombre` varchar(20) NOT NULL DEFAULT '',
  `seccion_tipo` int(1) NOT NULL,
  `seccion_orden` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`seccion_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 PACK_KEYS=0 AUTO_INCREMENT=24 ;

--
-- Volcar la base de datos para la tabla `matricula_secciones`
--

INSERT INTO `matricula_secciones` (`seccion_id`, `seccion_nombre`, `seccion_tipo`, `seccion_orden`) VALUES
(1, 'Alumnos 1A', 1, 1),
(2, 'Alumnos 1B', 1, 2),
(3, 'Alumnos 2A', 1, 3),
(4, 'Alumnos 2B', 1, 4),
...
CREATE TABLE IF NOT EXISTS `netbooks` (
  `netbook_id` int(11) NOT NULL AUTO_INCREMENT,
  `netbook_matricula_id` int(11) NOT NULL,
  `netbook_estado_id` int(3) NOT NULL,
  `netbook_marca_id` int(3) NOT NULL,
  `netbook_codigo` varchar(100) NOT NULL,
  `netbook_modelo` varchar(100) NOT NULL,
  `netbook_num_serie` varchar(100) NOT NULL,
  `netbook_num_win` varchar(100) NOT NULL,
  `netbook_num_office` varchar(100) NOT NULL,
  `netbook_macaddress` varchar(100) NOT NULL,
  `netbook_contrato` int(1) NOT NULL,
  `netbook_observaciones` longtext NOT NULL,
  PRIMARY KEY (`netbook_id`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;

--
-- Volcar la base de datos para la tabla `netbooks`
--
...
--
-- Estructura de tabla para la tabla `netbooks_estados`
--

CREATE TABLE IF NOT EXISTS `netbooks_estados` (
  `estado_id` int(3) NOT NULL AUTO_INCREMENT,
  `estado_nombre` varchar(50) NOT NULL DEFAULT '',
  PRIMARY KEY (`estado_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 PACK_KEYS=0 AUTO_INCREMENT=10 ;

--
-- Volcar la base de datos para la tabla `netbooks_estados`
--

INSERT INTO `netbooks_estados` (`estado_id`, `estado_nombre`) VALUES
(1, 'Normal'),
(2, 'Obsequiada'),
(3, 'No Devolvio'),
(4, 'Robada'),
(5, 'Espera de Reparación'),
(6, 'En Reparación'),
(7, 'Pase Finalizado'),
(8, 'Pase Solicitado'),
(9, 'Pase en Tramite');
...
--
-- Estructura de tabla para la tabla `netbooks_marcas`
--

CREATE TABLE IF NOT EXISTS `netbooks_marcas` (
  `marca_id` int(3) NOT NULL AUTO_INCREMENT,
  `marca_nombre` varchar(50) NOT NULL DEFAULT '',
  PRIMARY KEY (`marca_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 PACK_KEYS=0 AUTO_INCREMENT=11 ;

--
-- Volcar la base de datos para la tabla `netbooks_marcas`
--

INSERT INTO `netbooks_marcas` (`marca_id`, `marca_nombre`) VALUES
(1, 'Exomate'),
(2, 'Noblex'),
(3, 'Bangho'),
(4, 'Edunec'),
...
CREATE TABLE IF NOT EXISTS `soporte` (
  ...
  `soporte_estado_id` int(3) NOT NULL,
  `soporte_netbook_id` int(11) NOT NULL,
  `soporte_fecha_solicitud` bigint(14) NOT NULL,
  `soporte_nro_caso` varchar(20) NOT NULL,
  `soporte_descripcion` longtext NOT NULL,
  `soporte_reclamo` longtext NOT NULL,
...
--
-- Estructura de tabla para la tabla `soporte_estados`
--
...
--
-- Volcar la base de datos para la tabla `soporte_estados`
--

INSERT INTO `soporte_estados` (`estado_id`, `estado_nombre`) VALUES
(1, 'Espera de Retiro'),
(2, 'Retirada'),
(3, 'ALERTA'),
(4, 'Solucionado');
...
CREATE TABLE IF NOT EXISTS `usuarios` (
  ...
  `usuario_privilegio` smallint(2) NOT NULL,
  `usuario_nombre` varchar(100) NOT NULL,
  `usuario_apellido` varchar(100) NOT NULL,
  `usuario_tel` bigint(25) NOT NULL,
  `usuario_cel` bigint(25) NOT NULL,
